...
if (AuthOSM::check()) {
    echo '
			...
			<footer class="main-footer">
                <a class="hidden-xs" href="'.base_path_osm().'/info.php" title="'.tr("Safix, il gestionale per l'assistenza tecnica e la fatturazione elettronica").'."><strong>'.tr('Safix').'</strong></a>
